...
public class AdminController {
	...
	public ModelAndView productUpdatePost(ModelAndView mv, ProductVO product,
		...
		if(res)
			...
			messageService.message(response, "제품 수정에 실패했습니다.", "/lg/admin/product/list");
		mv.setViewName("/admin/productUpdate");
		return mv;
	}
	...
	public ModelAndView noticePostGet(ModelAndView mv, BoardVO board,
	...
	public ModelAndView noticeUpdatePost(ModelAndView mv, BoardVO board, 
		...
		if(res)
			...
			messageService.message(response, "공지사항 수정에 실패했습니다.", "/lg/admin/notice/update");
		return mv;
	}
