  ...
  <table class="table table-hover">
    ...
    <tbody>
    	<c:forEach items = "${list}" var="pro" >
	    	<tr>
	        <td> 
	        	<img alt="제품이미지" src="<c:url value="${pro.pr_thumb_url}"></c:url>" width="150px" height="150px">
	        </td>
	        <td>${pro.pr_ca_name}</td>
	        <td>${pro.pr_code}</td>
	        <td>
	        	<a href="<c:url value="/product/select?pr_code=${pro.pr_code}"></c:url>">
	        		${pro.pr_title}
	        	</a>	
       		</td>
	        <td>${pro.pr_price}</td>
	        <td>
	        	<a class="btn btn-outline-success" href="<c:url value="/product/update?pr_code=${pro.pr_code}"></c:url>">수정</a>
