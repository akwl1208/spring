...
<form class="container" enctype="multipart/form-data" method="post">
	...
	<!-- 제품 정보 입력 ---------------------------------------------------------------- -->
		<div class="float-right" style="width:calc(100% - 150px - 10px)">
			...
			<div class="form-group">
			  <input type="text" class="form-control" name="pr_code" readonly value="제품번호">
			</div>
			<div class="form-group">
	...
	<div class="form-group">
		 <textarea type="text" class="form-control" name="pr_content" placeholder="제품 설명"></textarea>
	</div>
	<div class="form-group">
...
<!-- 이벤트 ---------------------------------------------------------------- -->
	...
	$('form').submit(function(){
		let thumbImg = $('[name=file]').val();
		if(thumbImg == ''){
			alert('상품 대표 이미지를 입력하세요.');
			$('[name=file]').click();
			return false;
		}
